...
public class BillPrintable implements Printable {
  ...
  {    
      ...
      int r= itemName.size();
      ImageIcon icon=new ImageIcon("C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\HealthMgtSystemClient24600\\src\\view\\APEX HEALTH HAVEN timmed.png"); 
 ...
 private boolean isNumeric(String str) {
    ...
    private void savebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savebtnActionPerformed
      try{        
            ...
            BillService service =(BillService) theRegistry.lookup("bill");
            Bill Obj = new Bill();
            Obj.setPatientid(Integer.parseInt(idtxt.getText()));
            Obj.setPatientname(nametxt.getText());
            Obj.setInsurance(String.valueOf(insurancep.getSelectedItem()));
            Obj.setDate(datetxt.getDate());
            Obj.setIssued(doctortxt.getText());
            Obj.setAmount(Double.valueOf(txttotalAmount.getText()));
          Bill usersObj = service.recordBill(Obj);
             if(usersObj != null){
